...
[androidJvm]\
open fun [setSegmentationGap](set-segmentation-gap.md)(gapSize: [Int](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-int/index.html))
...
| | |
|---|---|
| gapSize | -     number of frames to skip between two segmentations |